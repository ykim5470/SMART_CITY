...
// const old_analysis_select = (socket) => {
...
//           return column_attr;
//         });
//         console.log(analysis_column)
//       return analysis_column;
//     };
//     console.log(analysis_output().then(result => console.log(result)))
...
// module.exports = old_analysis_select;
